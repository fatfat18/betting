  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-900 to-green-800 font-host">
      ...
      <div className="xl:w-1/4 w-5/6 mx-auto mt-10 p-8 bg-white bg-opacity-90 rounded-xl shadow-lg z-20">
        <div className="w-full font-host overflow-hidden flex xl:flex-row flex-col items-center  xl:h-48 h-52  bg-gradient-to-bl from-gray-900 via-gray-900 to-green-800 text-white rounded-md xl:p-8 p-4 relative">
          <div className="z-20 full w-2/3 xl:h-full font-extrabold xl:text-xl text-lg xl:text-start text-center translate-y-10 xl:translate-y-0 ">
            Register and claim your <span className="text-green-500 font-host font-bold">$2,500</span> by entering your promo code!
          </div>
          <div className="z-10 absolute -right-10 top-1  xl:p-4 p-2 ">
            <img src={"/assets/register/beast.png"} className="object-contain   h-52  w-52" />
          </div>
        </div>
