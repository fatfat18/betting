      ...
      <div className="w-1/3 p-6 ">
        <div className="bg-gradient-to-br from-black to-red-700  rounded-3xl p-6 h-60 relative overflow-hidden">
          ...
          <div className="absolute -bottom-10  -right-5 ">
            <img src="/assets/games/slot.webp" className="w-60 h-60 " />
          </div>
        </div>
      </div>
      <div className="w-1/3 p-6 ">
        <div className="bg-gradient-to-br from-black to-green-700  rounded-3xl p-6 h-60 relative overflow-hidden">
          ...
          <div className="absolute -bottom-30  -right-10">
            <img src="/assets/games/soccer.webp" className="w-80 h-80" />
          </div>
        </div>
      </div>
      <div className="w-1/3 p-6 ">
        <div className="bg-gradient-to-br from-black to-blue-700  rounded-3xl p-6 h-60 relative overflow-hidden">
          ...
          <div className="absolute -bottom-30  -right-15">
            <img src="/assets/games/cards.png" className="w-80 h-80" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="w-full mt-12">
      ...
      <div className="flex gap-10 flex-wrap items-center ">
        <div className="relative w-80 h-96 transition-colors duration-500 bg-radial to-black hover:via-black from-amber-900 rounded-md flex items-center justify-center text-3xl font-bold">
          <img src="/assets/games/cards.png" className="absolute w-48 h-48 z-10 opacity-10" />
      ...
      <div className="w-1/2 mt-12">
        ...
        <div className="w-full flex flex-wrap gap-8 ">
          <div className="relative w-60 h-80 transition-colors duration-500 ease-linear bg-gradient-to-b from-gray-950 via-gray-950 hover:via-amber-500 to-amber-500 rounded-md flex items-center justify-center text-3xl font-bold">
            <img src="/assets/games/soccer.webp" className="absolute w-48 h-48 z-10 opacity-10" />
      ...
      <div className="w-1/2 mt-12">
        ...
        <div className="w-full flex flex-wrap gap-8 ">
          <div className="relative w-60 h-80 transition-colors duration-500 ease-linear bg-gradient-to-br from-gray-950 via-gray-950 hover:via-cyan-300 to-cyan-300 rounded-md flex items-center justify-center text-3xl font-bold">
            <img src="/assets/games/slot.webp" className="absolute w-48 h-48 z-10 opacity-10" />
